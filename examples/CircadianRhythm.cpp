...
int main() {
    ...
    std::cout << "Starting simulation with " << circadian_rhythm.getSpecies().size() << " species and "
    ...
    plotSimulation(circadian_rhythm, result, "output/circadian_simulation.png", "Stochastic Simulation of Circadian Rhythm Model", exclude);
}
